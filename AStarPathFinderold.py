...
class AStarPathFinderold:
    def __init__(self, grid, pairs,underground_length=3,allow_jump = False):
        self.grid = grid
        ...
        self.jump_points = []  # Stores (start, end) of jumps
    ...
    def test_jump_over_terrain(self):
        ...
        astar = AStarPathFinderold(test_grid, pairs)
...
def main():
    ...
    astar = AStarPathFinderold(test_grid, pairs,3)
